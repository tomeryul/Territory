...
- **קרדיט** נצבר אוטומטית כל עוד הטאב פעיל על המסך (1 לשנייה).
- **כיבוש** משבצת פנויה צמודה לטריטוריה שלך — עולה קרדיט.
- **קנייה** של משבצת המוצעת למכירה (תגית ₪) מיריב — אם היא צמודה אליך.
- **עריכה**: בוחרים משבצת שלך ומשנים צבע/תמונה. כפתור "בחירה מרובה"
  מאפשר לשלוט בכמה משבצות כמקשה אחת.
